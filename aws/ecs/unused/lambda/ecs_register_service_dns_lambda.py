...
def lambda_handler(event, context):
    ...
    privatezone = os.environ.get('LAMBDA_DNS_ZONE_NAME')  # e.g. 'ecs.internal'
    zoneid = os.environ.get('LAMBDA_DNS_ZONE_ID')  # e.g. 'Route53PrivateHostedZoneID'
    cluster = os.environ.get('LAMBDA_ECS_CLUSTER_NAME')  # e.g. 'ECSClusterName'
